...
test('test', async ({ page }) => {
  ...
  await page.getByPlaceholder('Please Describe Your Business').fill('https://shopdemo-alex-hot.koyeb.app/https://shopdemo-alex-hot.koyeb.app/https://shopdemo-alex-hot.koyeb.app/');
  await page.getByRole('button', { name: 'Submit' }).click();
  await page.getByPlaceholder('Your Phone Number').click();
  await page.getByPlaceholder('Your Phone Number').click();
  await page.getByPlaceholder('Your Phone Number').click();
  await page.getByPlaceholder('Your Phone Number').fill('+440090090');
  await page.getByRole('button', { name: 'Submit' }).click();
  await page.getByPlaceholder('Your Phone Number').click();
  await page.getByPlaceholder('Your Phone Number').dblclick();
  await page.getByPlaceholder('Your Phone Number').click();
});